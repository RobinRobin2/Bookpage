...
<div id="header">
  <h1 class="header-text">bookpage</h1>
</div>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="index.php">Boka massage</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="bookinglist.php">Gjorda bokningar</a>
        </li>
      </ul>
    </div>
  </div>
